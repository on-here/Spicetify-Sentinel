  ...
  return (
    <div className="px-4 space-y-2.5">
      ...
      >
        ...
        {loading ? t.applying : t.autoHealBtn}
      </button>
      ...
      <div className="grid grid-cols-5 gap-2">
        <button
          ...
          disabled={loading}
          title={isBlocked ? t.btnBlockedTitle : t.btnAllowedTitle}
        ...
        >
          ...
          <span className="text-[10px] font-semibold leading-tight">
            {isBlocked ? t.btnBlocked : t.btnAllowed}
          </span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-medium leading-tight">{t.openApp}</span>
        </button>

        <button
          onClick={onCleanCache}
          disabled={loading}
          title={`${t.cleanCacheTitle} (${cacheSizeFormatted || '0 MB'})`}
        ...
        >
          ...
          <span className="text-[10px] font-medium leading-tight">{t.reapply}</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-medium leading-tight">{t.reinstall}</span>
        </button>
      </div>
    </div>
  );
