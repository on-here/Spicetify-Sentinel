...
# Render master image at 1024x1024 for maximum sharpness
$masterSize = 1024
...
$scale = [float]$masterSize / 256.0

# 1. Subtle Dark Emerald Circular Backdrop
$bgBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush(
    (New-Object System.Drawing.PointF(0, 0)),
    (New-Object System.Drawing.PointF($masterSize, $masterSize)),
    [System.Drawing.Color]::FromArgb(240, 18, 26, 22),
    [System.Drawing.Color]::FromArgb(255, 8, 12, 10)
)
$g.FillEllipse($bgBrush, (10.0 * $scale), (10.0 * $scale), (236.0 * $scale), (236.0 * $scale))

# Outer Emerald Glow Ring
$glowPen = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(120, 29, 185, 84), (4.0 * $scale))
$g.DrawEllipse($glowPen, (10.0 * $scale), (10.0 * $scale), (236.0 * $scale), (236.0 * $scale))
...
# Shield Body Fill (Rich Spotify Dark to Emerald gradient)
$shieldBrush = New-Object System.Drawing.Drawing2D.LinearGradientBrush(
    ...
    [System.Drawing.Color]::FromArgb(255, 29, 185, 84),
    [System.Drawing.Color]::FromArgb(255, 15, 110, 48)
)
$g.FillPath($shieldBrush, $shieldPath)

# Crisp Light Emerald Shield Border
$shieldPen = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(255, 30, 215, 96), (5.5 * $scale))
$g.DrawPath($shieldPen, $shieldPath)

# 3. Spotify Sound Waves Inside Shield (Brilliant White/Emerald)
...
$wavePen2 = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(240, 230, 255, 238), (8.5 * $scale))
$wavePen2.StartCap = [System.Drawing.Drawing2D.LineCap]::Round
$wavePen2.EndCap = [System.Drawing.Drawing2D.LineCap]::Round

$wavePen3 = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(220, 200, 255, 218), (7.0 * $scale))
...
# 4. Stylized Padlock at bottom of shield (Pure White Shackle & Solid Body with Keyhole)
...
# Padlock Keyhole (Spotify Emerald)
$holeBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(255, 15, 110, 48))
...
# High quality downsampler for all resolutions
...
foreach ($s in $sizes) {
    ...
    $g2.DrawImage($masterBmp, 0, 0, $s, $s)
    $g2.Dispose()
...
Write-Host "Premium Spotify Green Shield Icon generated at 1024x1024 master resolution!"
